...
import getTotalEmissions from './AddingTotalEmissions.jsx';
...
export default function SelectYear({ id }) {
  ...
  return (
    <div className='image-and-breakdown-container'>
      ...
      <h3 style={{ marginBottom: '0', marginTop: '0' }}>{getTotalEmissions(targetYear.allowances_sold, targetYear.eite_allocation).toLocaleString()} metric tons</h3>
    </div>
  );
}
